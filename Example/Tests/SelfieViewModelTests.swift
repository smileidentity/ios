...
final class SelfieViewModelTests: XCTestCase {
    ...
    func testBasics() {
        selfieViewModel
            .perform(action: .windowSizeDetected(
                    .zero,
...
class MockFaceValidator: FaceValidatorProtocol {
    ...
    func validate(faceGeometry: FaceGeometryData, selfieQuality: SelfieQualityData, brightness: Int, currentLivenessTask: LivenessTask?) {
        // perform validation
    }
}
