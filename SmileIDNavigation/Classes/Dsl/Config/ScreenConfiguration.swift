...
public struct SelfieCaptureConfig: Hashable { public let allowAgentMode: Bool
  public init(allowAgentMode: Bool = false) { self.allowAgentMode = allowAgentMode } }
...
public extension InstructionsScreenConfiguration {
  static func == (lhs: InstructionsScreenConfiguration, rhs: InstructionsScreenConfiguration) -> Bool {
