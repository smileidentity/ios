...
open class BaseSubmissionViewModel<ResultType: CaptureResult>: ObservableObject {
    ...
    internal var result: SmileIDResult<ResultType>?
    ...
    open func handleSuccess(data: ResultType) {
        fatalError("Must be implemented by subclass")
    }
    ...
    open func handleSubmissionFiles(jobId: String) throws {
        fatalError("Must be implemented by subclass")
    }
    ...
    internal func proxyErrorHandler(jobId: String, error: Error) {
