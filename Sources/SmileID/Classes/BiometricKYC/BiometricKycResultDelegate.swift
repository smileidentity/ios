...
public protocol BiometricKycResultDelegate: AnyObject {
    ...
    ///   - didSubmitBiometricJob: Indicates whether the job was submitted to the SmileID backend
    ///   (e.g. it would be false in offline mode)
    func didSucceed(
        selfieImage: URL,
        livenessImages: [URL],
