    ...
    public var body: some View {
        CaptureInstructionView<SelfieCaptureView>(
            ...
            instructions: [
                ...
                CaptureInstruction(title: SmileIDResourcesHelper.localizedString(for:"Instructions.ClearImage"), instruction: SmileIDResourcesHelper.localizedString(for:"Instructions.ClearImageBody"), image: Constants.ImageName.clearImage),
                CaptureInstruction(title: SmileIDResourcesHelper.localizedString(for:"Instructions.RemoveObstructions"), instruction: SmileIDResourcesHelper.localizedString(for:"Instructions.RemoveObstructionsBody"), image: Constants.ImageName.face)],detailView: SelfieCaptureView(
                    viewModel: viewModel,
