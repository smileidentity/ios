...
public struct SmileIDResourcesHelper {
    ...
    public static var bundle: Bundle {
        if nil == SmileIDResourcesHelper.internalBundle {
            ...
            let resourceBundle = Bundle(url: url.appendingPathComponent(bundleID))
            if let finalResourceBundle = resourceBundle {
                SmileIDResourcesHelper.internalBundle = finalResourceBundle
            }
        }
    ...
    private class FontLoader {
        ...
        static var loadedFonts: [String: String] = [String: String]()
        ...
        static func loadFontIfNeeded(name: String) {
            ...
            if nil == loadedFont && nil == UIFont(name: name, size: 1) {
                ...
                bundle.url(forResource: name, withExtension: "ttf", subdirectory: bundleID)
