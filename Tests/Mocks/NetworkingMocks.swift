...
class NewMockSmileIDServiceable: Mock<SmileIDServiceable>, SmileIDServiceable {
    ...
    func getJobStatus<T>(request: JobStatusRequest) -> AnyPublisher<JobStatusResponse<T>, Error> where T : JobResult {
    ...
    func getProductsConfig(request: ProductsConfigRequest) -> AnyPublisher<ProductsConfigResponse, Error> {
