...
@objcMembers
class EnhancedSelfieCaptureViewController: UIViewController {
    let viewModel: EnhancedSelfieCaptureViewModel = EnhancedSelfieCaptureViewModel()
    ...
    private func embedSwiftUIView() {
        let smartSelfieView = SmileID.smartSelfieEnrollmentScreenEnhanced(delegate: viewModel)
