...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  # s.resource_bundles = {
  #   'Resources' => ['SmileID/Assets/en.lproj','SmileID/Assets/**/*.{storyboard,storyboardc,xib,nib,xcassets,json,png,ttf}','SmileID/Assets/**/**/*.{storyboard,storyboardc,xib,nib,xcassets,json,png,ttf}']
  # }
